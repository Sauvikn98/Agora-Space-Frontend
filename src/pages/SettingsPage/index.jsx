            ...
            <div className="flex flex-col min-h-screen">
                ...
                <div className="flex-grow">
                    <div className="mx-auto px-4 sm:px-6 lg:px-44 py-4">
                                        ...
                                        <div class="border-b border-gray-900/10 pb-12">
                                            ...
                                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                                <div class="sm:col-span-4">
                                                    ...
                                                    <div class="mt-2">
                                                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                                            ...
                                                            <input type="text" name="username" id="username" autocomplete="username" class="outline-none  block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 placeholder:pl-3 focus:ring-0 sm:text-sm sm:leading-6" placeholder="senior7778" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-span-full">
                                                    ...
                                                    <div class="mt-2">
                                                        <textarea id="about" name="about" rows="6" class="resize-none outline-none  block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                                                    </div>
                        ...
                        {activeTab === 'languages' && (
                            <div>
                                <h2 className="text-2xl font-semibold mb-4">Laguage Settings</h2>
                                <form>
                                    {/* Notification settings form fields */}
                                </form>
                            </div>
                        ...
                        {activeTab === 'preferences' && (
                            <div>
                                <h2 className="text-2xl font-semibold mb-4">Preference Settings</h2>
                                <form>
                                    {/* Notification settings form fields */}
                                </form>
                            </div>
