...
import { newCommentState, useCreateComment } from '../../../recoil/atoms/commentAtoms';
import { userAtom } from '../../../recoil/atoms/userAtoms';
import CommentValidation from '../../Modals/ValidationModal/CommentValidationModal';
import { handleNewComment } from '../../../utils/commentUtils';
      ...
      <div className=' py-2 lg:w-[700px] px-4 mt-6 mb-4 rounded-lg rounded-t-lg border-2 border-gray-500 '>
        <div className ="px-4 py-2 rounded-t-lg dark:bg-gray-800">
          ...
          <textarea
            id="comment"
            rows="8"
            className="resize-none  outline-none w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
