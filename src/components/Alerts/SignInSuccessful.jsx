        ...
        <>
            {isAuthenticated && (
                <div id="alert-3" className="flex p-4 bg-green-600 text-white " role="alert">
                    ...
                    <button onClick={dismissAlert} type="button" className="ml-auto -mx-1.5 -my-1.5 bg-white text-green-600 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-3" aria-label="Close">
