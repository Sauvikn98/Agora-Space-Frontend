...
import { handleLogoutAllSessions } from '../../../utils/userUtils';
            ...
            <div class="min-h-full h-full w-full flex justify-center items-center text-center">
                <div class="flex flex-col justify-between h-full">
                    ...
                    <div class="flex items-center justify-between w-full gap-4 mt-8">
                        <button onClick={handleLogoutAllSessions(user.accessToken, setUserData, navigate)} type="button" class="py-2 px-4  bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                            Yes
                        </button>
